...
public class Enemy_Text extends Enemy{
	 ...
	 * Enemy class, using gridErrorCheck to make sure the are not 0 or the max values
	 * @param x_coordinate The x coordinate from the logic Enemy class.
	 * @param y_coordinate The y coordinate from the logic Enemy class.
	 */
